export const lesson_1_2_content = "LEAD ON<br/>" +
    "Question:<br/>" +
    ...
    "<br/>" +
    "Image of God: unique to humans<br/>" +
    ...
    "<br/>" +
    "Image of God in man means rule over creation<br/>" +
    ...
    "Stewardship of possessions (money, talent, time, etc.)<br/>"