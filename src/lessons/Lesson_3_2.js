export const lesson_3_2_content = "LEAD ON<br/>" +
    "Question:<br/>" +
    ...
    "<br/>" +
    "The consequence: shame and guilt<br/>" +
    ...
    "<br/>" +
    "The Old Covenant: sacrificial system<br/>" +
    ...
    "<br/>" +
    "The New Covenant: saving sacrifice<br/>" +
    ...
    "Let us draw near with confidence to the presence of God (vv19-22). Talk about the last time you drew near to God in prayer or personal quiet time.<br/>" +
    "Let us hold fast to our hope without wavering (V23). What things in your life make your hope in God waver or weaken? <br/>" +
