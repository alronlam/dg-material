export const lesson_2_3_content = "LEAD ON:<br/>" +
    "Question:<br/>" +
    "Share a travel experience you had where you were able to see the wonders of God’s creation. <br/>" +
    "<br/>" +
    "OPEN WORD:<br/>" +
    "As God’s representatives, bearer’s of His image and stewards of creation on His behalf, man and woman were not the only ones affected by the Fall. Even the rest of creation suffers the consequences of sin. Originally, God called His creation “very good,” but as sin came God Himself cursed it (“the ground”) so that it brings suffering and pain to all its inhabitants. We can then say that we currently live in a fallen, broken world.<br/>" +
    "<br/>" +
    "Creation was subjected to futility<br/>" +
    "Paul, in Romans 8:20-22, tells us the “story behind the story,” what happened to God’s creation because of sin, and what it meant.<br/>" +
    "<br/>" +
    ...
    "<br/>" +
    "Sin damages man’s relationship with the rest of God’s creation<br/>" +
    ...
    "<br/>" +
    "Work became difficult and painful<br/>" +
    ...
    "<br/>" +
    "LIVE OUT:<br/>" +
    "Share particular struggle/s in your life (personal, work, at home, etc.) and how you can be prayed for.<br/>"